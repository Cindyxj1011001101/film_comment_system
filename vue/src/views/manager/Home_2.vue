<template>
  <div style="display: flex; grid-gap: 10px">
    <div class="card" style="width: 50%; padding: 20px">
      <div style="margin-bottom: 20px; font-size: 20px; font-weight: bold">最新书籍评分榜ღ</div>
      <div v-for="(item, index) in data.bookList" :key="item.id" @click="goDetail(item.id)" style="cursor: pointer; margin-bottom: 10px">
        <div style="display: flex; grid-gap: 10px">
...
request.get('/book/selectRanking').then(res => {
